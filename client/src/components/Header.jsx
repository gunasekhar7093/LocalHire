...
const Header = () => {
  const { user, unreadTotal, logout } = useContext(AuthContext);
  ...
  return (
    <>
      <header className="top-header">
        ...
        <div className="header-right-actions">
          ...
          {user ? (
            ...
            <div className="auth-header-btn-group">
      ...
      {showLogoutModal && (
        <div className="header-modal-overlay" onClick={() => setShowLogoutModal(false)}>
          <div className="header-logout-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="header-logout-modal-desc">
              Are you sure you want to log out of your LocalHire account?
            </p>
